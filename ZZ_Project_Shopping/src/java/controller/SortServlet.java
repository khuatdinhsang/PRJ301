...
public class SortServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Product_M> listSort= new ArrayList<>();
        String sort_price=request.getParameter("sort_price");
        if (sort_price.equals("-1")){
            listSort=d.getDescPriceProduct(cid);
        } else if (sort_price.equals("1")){
            listSort=d.getAscPriceProduct(cid);
        } else if (sort_price.equals("0")){
           listSort=d.getListProductByCategory1(cid);
        }
