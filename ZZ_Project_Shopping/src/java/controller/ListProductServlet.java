...
public class ListProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int numPro = pD.countProduct();
        ArrayList<Product_M> listProduct = (ArrayList<Product_M>) pD.getAllProduct();
        request.setAttribute("getListProduct", listProduct);
        request.setAttribute("numPro", numPro);
        List<Product_M> list1 = pD.getAllProduct();
        // Phân Trang
        ...
        List<Product_M> list = pD.getListByPage((ArrayList<Product_M>) list1, start, end);
